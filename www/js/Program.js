...
function onDeviceReady() {
    ...
    //Test Code for taking picture__EJ
    let options = {
        x: 0,
        y: 0,
      ...
      CameraPreview.startCamera(options, function(){
        //Test Take Picture_EJ
      CameraPreview.takePicture({width:640, height:640, quality: 85}, function(base64PictureData){
        /*
          base64PictureData is base64 encoded jpeg image. Use this data to store to a file or upload.
          Its up to the you to figure out the best way to save it to disk or whatever for your application.
        */
        var pic = base64PictureData;
        //use "ngrok http 5000" to create local server and then do a post to send to file location
        //Test section for xmlHttpRequest
        var httpPost = new XMLHttpRequest()
        httpPost.open('POST',"http://3f48c25b.ngrok.io/uploaded_images",false); //BaseURL will change...use /uploaded_images with new URL
        httpPost.send(pic);
        //alert("Picture Taken")
      });
